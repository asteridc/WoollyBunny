...
public class ChainSlot : MonoBehaviour, IDropHandler
{
    ...
    public void OnDrop(PointerEventData eventData)
    {
        ...
        // Не позволяем вставлять в занятый слот
        ...
        // Меняем родителя и центрируем
        dragTool.transform.SetParent(transform, worldPositionStays: false);
        dragTool.rectTransform.anchoredPosition = Vector2.zero;

        // Снимаем подсветку со всех слотов
